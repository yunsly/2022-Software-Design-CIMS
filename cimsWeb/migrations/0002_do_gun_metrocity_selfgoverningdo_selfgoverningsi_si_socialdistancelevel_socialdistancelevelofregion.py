...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Do',
            fields=[
                ('socialdistancelevelofregion_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cimsWeb.socialdistancelevelofregion')),
            ],
            bases=('cimsWeb.socialdistancelevelofregion',),
        ),
        migrations.CreateModel(
            name='Gun',
            fields=[
